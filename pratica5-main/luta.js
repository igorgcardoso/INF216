...
function create() {
    ...
    this.anims.create({
        key: 'ground',
        frames: this.anims.generateFrameNumbers('lutadorB', { start: 26, end: 28 }),
        frameRate: 2, repeat: -1
    })

    this.anims.create({
        key: 'dodge',
        frames: this.anims.generateFrameNumbers('lutadorB', { start: 41, end: 51 }),
        frameRate: 10, repeat: -1
    })
...
function update() {
    ...
    if (cursors.left.isDown) {
        ...
        lutB.anims.play('ground', true);
    } else if (cursors.space.isDown) {
        lutB.setVelocityX(-50);
        lutB.anims.play('dodge', true);
    }
}
